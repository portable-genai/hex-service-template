...
class TriageResponse(BaseModel):
    ...
    #: reference. Empty only when the result did not escalate. A caller can tell a routed escalation
    #: from a flag that stopped here, which is the whole point of the rule.
    review_ref: str = ""
