...
read
    ...
    bind_profile == local AND profile chosen AND {{ cookiecutter.env_prefix }}_S2S_TOKEN unset
...
from {{ cookiecutter.package_name }}.adapters.gcp.identity import (
    IapIdentityAdapter,
)
from {{ cookiecutter.package_name }}.adapters.local.identity import (
    LocalIdentityAdapter,
)
from {{ cookiecutter.package_name }}.adapters.onprem.identity import (
...
from {{ cookiecutter.package_name }}.ports.identity import (
    CLIENT_ASSERTED,
    END_USER_AUTH_ATTR,
    END_USER_AUTH_KINDS,
    UNIMPLEMENTED,
...
_PKG = "{{ cookiecutter.package_name }}"
