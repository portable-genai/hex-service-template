...
``{{ cookiecutter.env_prefix }}_S2S_TOKEN`` used to switch the guard off under a DELIBERATE
...
from {{ cookiecutter.package_name }}.api.app import (
    app,
)
...
_IAP_AUDIENCE_ENV = "{{ cookiecutter.env_prefix }}_IAP_AUDIENCE"
...
_API_MODULE = "{{ cookiecutter.package_name }}.api.app"
