...
export const TWO_STATE_READS_WITH_A_REASON = {
  AGENT_S2S_TOKEN:
    ...
    "decides, and the receiver (`make_require_service_caller`) is three-state as of v0.5.1, so " +
    "an emptied secret refuses there. Raising here would convert a receiver-enforced 401 into a " +
    "caller crash and move the decision to the end of the call that has no authority over it.",
};
